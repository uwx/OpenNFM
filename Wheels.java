...
public class Wheels {
	...
	public void make(final Medium medium, final Trackers trackers, final Plane aplane[], int i, final int j,
			final int k, final int l, final int i1, final int j1, final int k1, final int l1) {
		final int ai[] = new int[16];
		final int ai1[] = new int[16];
		final int ai2[] = new int[16];
		final int ai3[] = { 45, 45, 45 };
		int i2 = 0;
